...
$edit_ary = array (
	"chunk1" => array (
		"title"=>"Upgrade Registration Content",
		...
		"blanks"=>"1",		
		"table_name"=>"upgrade_registration",
...
<table width="755" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr valign="top" bgcolor="#FFFFFF">
    ...
    <td colspan="5" valign="top" bgcolor="#FFFFFF"><table width="525"  border="0" align="center" cellpadding="5" cellspacing="0" id="desc">
        ...
        <tr bgcolor="#FFFFFF">
          <td class="text1"><?php content_display("chunk1","<p>","</p>"); ?> <b><br>
              <font color="#CC0000">* 
        ...
        <tr bgcolor="#EDEDED">
          ...
          <?php
          	if((isset($return_form))) {
          		form_upgraderegister($_POST['product'],$_POST['sub_dir'],$_SESSION['userid'],$return_form);
          	} else {
          		form_upgraderegister($_POST['product'],$_POST['sub_dir'],$_SESSION['userid']);
          	} 
          ?></td>
        </tr>
      </table></td>
