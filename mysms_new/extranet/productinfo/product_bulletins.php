...
<table width="755" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="10">&nbsp;</td>
    <td width="727" height="23" valign="middle" class="text1">Back to: <a href="/index.php" class="text1">firstamsms.com</a> &raquo; <a href="../index.php" class="text1">MySMS</a> &raquo; <a href="product_bulletins_select.php" class="text1">Product Bulletins </a></td>
  </tr>
  <tr bgcolor="#CCCCCC">
  ...
  <tr valign="top" bgcolor="#FFFFFF">
    ...
    <td colspan="5" valign="top" bgcolor="#FFFFFF"><table width="525"  border="0" align="center" cellpadding="5" cellspacing="1">
      ...
      <tr bgcolor="#FFCC00" class="textbody">
        <td width="249" align="left" bgcolor="#FFFFFF"><b><font color="#CC0000"><?php print $product; ?></font></b></td>
    ...
    <table width="525"  border="0" align="center" cellpadding="5" cellspacing="1">
      <tr bgcolor="#FFCC00" class="textbody">
        <td width="334" bgcolor="#FFCC00"><b>Product Bulletins </b></td>
        <td width="80"><b>File Size </b></td>
        <td width="110" align="center"><b>Download Link </b></td>
      </tr>
      <tr bgcolor="#EDEDED">
        <td class="textbody">Filename 1</td>
        <td width="80" class="textbody">100k</td>
      ...
      <tr bgcolor="#EDEDED">
        ...
        <td width="80" class="textbody">200k</td>
        <td width="110" align="center"><img src="../../images/arrow2.gif" width="4" height="17" align="absmiddle"><a href="#"> Download</a></td>
      </tr>
      <tr bgcolor="#EDEDED">
        <td class="textbody">Filename 3</td>
        <td width="80" class="textbody">300k</td>
        <td width="110" align="center"><img src="../../images/arrow2.gif" width="4" height="17" align="absmiddle"><a href="#"> Download</a></td>
      </tr>
      <tr bgcolor="#EDEDED">
        <td class="textbody">Filename 4 </td>
        <td width="80" class="textbody">220k</td>
        <td width="110" align="center"><img src="../../images/arrow2.gif" width="4" height="17" align="absmiddle"><a href="#"> Download</a></td>
      </tr>
    </table>
      <table width="525"  border="0" align="center" cellpadding="5" cellspacing="1">
