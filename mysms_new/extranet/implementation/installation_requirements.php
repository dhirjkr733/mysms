...
$edit_ary = array (
	"chunk1" => array (
		"title"=>"Installation Requirements Content",
		...
		"blanks"=>"1",		
		"table_name"=>"installation_requirements",
    ...
    <td colspan="5" valign="top" bgcolor="#FFFFFF"><table width="525"  border="0" align="center" cellpadding="5" cellspacing="0" id="desc">
      <tr bgcolor="#FFCC00" class="textbody">
        <td bgcolor="#FFCC00"><table width="515" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="321" class="textbody"><b>Installation Requirements </b></td>
              <td width="194" align="right">&nbsp;</td>
            </tr>
        </table></td>
      </tr>
      <tr bgcolor="#FFFFFF">
        <td valign="top" class="text1"><?php content_display("chunk1","<p>","</p>"); ?>
          </td>
      </tr>
      <tr bgcolor="#FFFFFF">
        <td class="text1">&nbsp;</td>
...
<input type="hidden" name="type" id="type" value='Installation Requirement'>
</form>
