...
$ftp_info = array (
	"directory"=>CUSTOMER_SURVEY_FTP_DIR,
...
$edit_ary = array (
	"chunk1" => array (
		"title"=>"Customer Surveys Content",
    ...
    <td colspan="5" valign="top" bgcolor="#FFFFFF"><table width="525"  border="0" align="center" cellpadding="5" cellspacing="0" id="desc">
      <tr bgcolor="#FFCC00" class="textbody">
        <td bgcolor="#FFCC00"><table width="515" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="321" class="textbody"><b>Customer Surveys</b></td>
...
<input type="hidden" name="type" id="type" value='Customer Survey'>
</form>
