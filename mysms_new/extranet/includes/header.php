...
// this link is used for the Right Answers link in the javascript menu
echo "<SCRIPT language=Javascript>var rarnLink = '/extranet/support/right-answers.php';</SCRIPT>\n";
?>
<SCRIPT language=JavaScript src="/extranet/js/mysms_array.js" type=text/javascript></SCRIPT>
<SCRIPT language=JavaScript src="/extranet/js/mysms.js" type=text/javascript></SCRIPT>
...
<table width="755" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td valign="top" class="headerbg">
      <table width="755" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="330"><a href="/index.php"><img src="/images/firstamsms.jpg" width="94" height="72" hspace="0" border="0" /></a></td>
...
<table width="755" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="5">&nbsp;</td>
    <td width="654" height="23" valign="middle" class="text1">
    	Logged in as  <?php print "{$_SESSION['firstname']} {$_SESSION['lastname']}"; ?>&nbsp;&nbsp;( 
    	<a href="https://cms.external.smscorp.com/EditProfile.aspx?UserToken=<?php echo urlencode($_SESSION['usertoken']); ?>" class="text1">Edit Profile</a>)
    </td>
    <td width="92" align="right" valign="middle" class="text1"><a href="<?php print APPLICATION_HOME_PAGE; ?>?logout=logout" class="text1">Log Out</a></td>
  </tr>
  <tr bgcolor="#CCCCCC">
