  ...
  <tr valign="top">
    ...
    <td class="text1"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" id="subnav">
        ...
        <tr valign="top">
          ...
          <td><a href="mailto:software.support@smscorp.com">Email SMS Customer Support </a></td>
        </tr>
        <tr valign="top">
          <td height="5" colspan="2"><img src="/images/spacer.gif" width="1" height="5"></td>
        </tr>
        ...
        <tr valign="top">
          <td width="10" height="18"><img src="/images/arrow2.gif" width="4" height="17"></td>
          <td><a href="/extranet/support/right-answers.php" onClick="popUP('/extranet/support/right-answers.php','RightAnswers',1344,700,1,1);return false;">Right Answers Right Now </a></td>
        </tr>
    </table></td>
  </tr>
</table>