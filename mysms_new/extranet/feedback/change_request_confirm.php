...
";
				...
				if ($attachment !== "") {
					...
					sendAttachment(SOFTWARE_CHANGE_EMAIL.$emails_result,"MySMS Member Request for Software Change",$mailmsg,"From: ".ADMINISTRATION_EMAIL,$attachment_array);
					if (file_exists(UPLOADED_FILES_TEMP_DIR.$new_filename)) {
						unlink(UPLOADED_FILES_TEMP_DIR.$new_filename);
					}
				} else {
					//mail(SOFTWARE_CHANGE_EMAIL.$emails_result,"MySMS Member Request for Software Change",$mailmsg,"From: ".ADMINISTRATION_EMAIL."\r\n");
					mail(SOFTWARE_CHANGE_EMAIL,"MySMS Member Request for Software Change",$mailmsg,"From: ".ADMINISTRATION_EMAIL."\r\n");
				}
				$confirm = true;
			}
		}
...
$edit_ary = array (
	"chunk1" => array (
		"title"=>"Software Change Request Confirmation Content",
		...
		"blanks"=>"1",		
		"table_name"=>"software_change_request_confirm",
