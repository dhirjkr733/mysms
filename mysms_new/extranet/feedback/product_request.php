...
$edit_ary = array (
	"chunk1" => array (
		"title"=>"Request Product Info Content",
		...
		"blanks"=>"1",		
		"table_name"=>"request_product_info",
...
<table width="755" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr valign="top">
    ...
    <td class="text1"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" id="subnav">
        <tr valign="top">
          ...
          <td><a href="/public/contact/helpdesk_sms.php">SMS Customer Support</a></td>
				...
				<tr valign="top">
          <td width="10"><img src="/images/arrow2.gif" width="4" height="17"></td>
          <td><a href="/public/contact/helpdesk_trustacct.php">TrustLink Help Desk</a></td>
        </tr>
				<tr valign="top">
					<td height="5" colspan="2"><img src="/images/spacer.gif" width="1" height="5"></td>
				</tr>
    ...
    <td colspan="5" valign="top" bgcolor="#FFFFFF"><table width="525"  border="0" align="center" cellpadding="5" cellspacing="0" id="desc">
      ...
      <tr bgcolor="#FFFFFF">
        <td valign="top" bgcolor="#FFFFFF" class="text1"><?php content_display("chunk1","<p>","</p>"); ?><font color="#CC0000"> <strong><b>
          * </b></strong><b>Required Fields </b></font>
        ...
        <tr bgcolor="#FFFFFF">
          ...
          <?php
          	if((isset($return_form))) {
          		form_productrequest($_SESSION['userid'],$return_form);
          	} else {
          		form_productrequest($_SESSION['userid']);
          	} 
          ?></td>
        </tr>
      </table>
