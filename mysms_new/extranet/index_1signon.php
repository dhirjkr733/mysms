		...
		if (!$user_info = ValidateSMS($email, $password)) {
			...
			switch ($user_info['LoginResponse']['LoginStatus']['Status']) {
				...
				case "Active": case "Approved": case 'Approved-Activated':
					...
					//TESTING ONLY
					//email the raw xml that we get from SMS
					//mail('karl@calibermg.com','Raw xml from MySMS',$user_info['LoginResponse']['RawData'],"From: website@firstamsms.com");
...
<table width="755" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr valign="top" bgcolor="#FFFFFF">
    <td width="188" align="center">
		<?php require_once('includes/subnav_support_test.php'); ?>
		<br>
