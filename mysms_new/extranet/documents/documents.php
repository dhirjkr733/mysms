...
$ftp_info = array (
	"directory"=>DOCUMENT_FTP_DIR."/$state",
    ...
    <td colspan="5" valign="top" bgcolor="#FFFFFF"><table width="525"  border="0" align="center" cellpadding="5" cellspacing="0" id="desc">
        <tr bgcolor="#FFCC00" class="textbody">
          <td bgcolor="#FFCC00"><table width="515" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td class="textbody"><b>Documents: <font color="#CC0000"><?php print $STATE_ARRAY[$state]; ?></font></b></td>
              <td width="250" align="right"><?php showStateSelect('state', '', 'change', 'Change State', 'onchange="document.change_state.submit();"'); ?></td>
            </tr>
            </form>
          </table></td>
        </tr>
