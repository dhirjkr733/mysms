...
$ftp_info = getFTP($product,'Check Samples');
    ...
    <td colspan="5" valign="top" bgcolor="#FFFFFF"><table width="525"  border="0" align="center" cellpadding="5" cellspacing="0" id="desc">
        <tr bgcolor="#FFCC00" class="textbody">
          <td bgcolor="#FFCC00"><table width="515" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td class="textbody"><b>Check Samples: <font color="#CC0000"><?php print $product; ?></font></b></td>
              <td width="250" align="right"><?php showProductSelectFiltered('product', '', 'change', 'Change Product', 'onchange="document.change_product.submit();"',false,array('VISION', 'Image-Pro', 'Trust32', 'ClosingTracker.com','OrderDesk','TrustLink','GreenFolders')); ?></td>
            </tr>
            </form>
          </table></td>
        </tr>
...
<input type="hidden" name="type" id="type" value='Check Samples'>
