...
<table width="755" border="0" cellspacing="0" cellpadding="0">
	<tr>
    	<td valign="top" class="headerbg">
			<table width="755" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="330"><a href="http://www.firstamsms.com/"><img src="/images/firstamsms.gif" width="317" height="62" hspace="0" border="0"></a></td>
...
<table width="755" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td width="188">
			<?php form_login_test('http://mysms.firstamsms.com/extranet/index_1signon.php','POST','http://cms.beta.smscorp.com/ForgotPassword.aspx'); ?>
		</td>
	</tr>
	<!--
	<tr>
...
<br>
  ...
  <?php// require_once('public/includes/subnav_discountclub.php'); ?>
    ...
    <td width="1" bgcolor="#CCCCCC"><img src="../images/pixel.gif" width="1" height="1"></td>
    <td width="187" align="center"><?php require_once('public/includes/subnav_register_test.php'); ?></p>
