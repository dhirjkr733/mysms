                  ...
                  <td colspan="2" class="text1"><p><br>
                      ...
                      <table width="500" border="0" cellpadding="0" cellspacing="1" class="content">
                        <tr valign="middle" class="textbody">
                          <td width="40"><input name="Iaminterestedin[]" type="checkbox" id="Iaminterestedin[]" value="StreamLine" size="20"<?php if (in_array('StreamLine',$iaminterestedin)) print " checked"; ?>></td>
                          <td width="230" class="text1">StreamLine</td>
                        ...
                        <tr valign="middle" class="textbody">
                          <td width="40"><input name="Iaminterestedin[]" type="checkbox" id="Iaminterestedin[]" value="VISION" size="20"<?php if (in_array('VISION',$iaminterestedin)) print " checked"; ?>></td>
                          <td width="230" class="text1">VISION</td>
                        ...
                        <tr valign="middle" class="textbody">
                          <td width="40"><input name="Iaminterestedin[]" type="checkbox" id="Iaminterestedin[]" value="DocNet" size="20"<?php if (in_array('DocNet',$iaminterestedin)) print " checked"; ?>></td>
                          <td width="230" class="text1">DocNet</td>
                          <td width="40"><input name="Iaminterestedin[]" type="checkbox" id="Iaminterestedin[]" value="Lockbox Services" size="20"<?php if (in_array('Lockbox Services',$iaminterestedin)) print " checked"; ?>></td>
                          <td width="230" class="text1">Lockbox Services</td>
                        </tr>
                        <tr valign="middle" class="textbody">
                          <td width="40"><input name="Iaminterestedin[]" type="checkbox" id="Iaminterestedin[]" value="ClosingTracker.com" size="20"<?php if (in_array('ClosingTracker.com',$iaminterestedin)) print " checked"; ?>></td>
                          <td width="230" class="text1">ClosingTracker.com</td>
                          <td width="40"><input name="Iaminterestedin[]" type="checkbox" id="Iaminterestedin[]" value="Hardware Maintenance Service" size="20"<?php if (in_array('Hardware Maintenance Service',$iaminterestedin)) print " checked"; ?>></td>
                          <td width="230" class="text1">Hardware Maintenance Service</td>
                        </tr>
                        <tr valign="middle" class="textbody">
                          <td width="40"><input name="Iaminterestedin[]" type="checkbox" id="Iaminterestedin[]" value="Document Imaging" size="20"<?php if (in_array('Document Imaging',$iaminterestedin)) print " checked"; ?>></td>
                          <td width="230" class="text1">Document Imaging</td>
                          <td width="40"><input name="Iaminterestedin[]" type="checkbox" id="Iaminterestedin[]" value="Discount Club" size="20"<?php if (in_array('Discount Club',$iaminterestedin)) print " checked"; ?>></td>
                          <td width="230" class="text1">Discount Club</td>
                        </tr>
                        <tr valign="middle" class="textbody">
...
<input name="fax3" type="text" id="fax3" size="4" maxlength="4" value="<?php print $edit ? $info['fax3'] : stripslashes($user['fax3']); ?>">
                ...
                <tr class="textbody">
                  ...
                  <?php
                  	...
                  	showProductSelect("product",$product,"uploadinputs","Select...",'',true);
                  ?></td>
                </tr>
                <tr class="textbody">
