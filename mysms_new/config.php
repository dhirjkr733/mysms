<?php
// define constants
define("APPLICATION_HOME_PAGE","http://localhost/mysms/index.php");
define("APPLICATION_ADMIN_HOME_PAGE","http://localhost/mysms/admin/index.php");
define("EXTRANET_HOME_PAGE","http://localhost/mysms/extranet/index.php");
define("FTP_TEMP_DIR","/var/www/html/mysms/extranet/downloads/temp/");
define("UPLOADED_FILES_TEMP_DIR","/var/wwww/html/mysms/extranet/uploads/temp/");
