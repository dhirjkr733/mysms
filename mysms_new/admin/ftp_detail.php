    ...
    <td colspan="7" valign="top" bgcolor="#FFFFFF"><table width="100%"  border="0" align="center" cellpadding="5" cellspacing="0" id="desc">
      <tr bgcolor="#FFCC00" class="textbody">
        <td bgcolor="#FFCC00"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td class="textbody"><b>Edit MySMS FTP Location</b></td>
              <td align="right">&nbsp;</td>
            </tr>
        </table></td>
      </tr>
      <tr bgcolor="#FFFFFF">
        <td valign="top" bgcolor="#FFFFFF" class="text1"><p>Use this form to edit this FTP Location. <b><br>
              <font color="#CC0000">* 
        ...
        <tr bgcolor="#EDEDED">
          ...
          <?php
          	if (is_array($ftp_info)) {
          		form_edit_FTP($ftp_info);
          	} else {
          		print "Invalid id. No record returned.";
          	} 
          ?></td>
        </tr>
      </table>
