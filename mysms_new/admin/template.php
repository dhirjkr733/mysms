...
if ((!isset($_SESSION['logged_in'])) || (!isset($_SESSION['admin']))) { // already logged in?
	$logged_in = false;
} else {
	$logged_in = true;
}
...
if (!$logged_in) {
	...
	session_destroy();
	ob_end_flush();
	if ($login_error == "") $login_error = "Your session has expired. Please <a href=\"index.php\">log in again</a>.";
	...
	switch ($_POST['searchby']) {
		...
		case "email":
			...
			break;
		default:
			$criteria = " AND registration_status='Pending'";
			break;
	}
	if($_POST['sortby'] != "") {
	...
	$sql = "SELECT id, firstname, lastname, email, DECODE(password,'".SALT."') AS password, registration_status
			FROM users
			WHERE id !='' $criteria";
...
<table width="755" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr valign="top" bgcolor="#FFFFFF">
    <td colspan="8" valign="top" bgcolor="#FFFFFF"><table width="755"  border="0" align="center" cellpadding="5" cellspacing="0" id="desc">
      ...
      <tr bgcolor="#FFFFFF">
        <td valign="top" bgcolor="#FFFFFF" class="text1"><p>Please enter your search criteria below.</p></td>
      </tr>
    </table>
    <table width="100%" bgcolor="#000000" border="0" align="center" cellpadding="2" cellspacing="1" id="prev">
        ...
        <td valign="middle" align="center" bgcolor="#FFFFFF" class="textbody">
       	<form name="search2" id="search2" method="POST" action="user_summary.php">
        	<table border="0" cellpadding="0" cellspacing="5">
        		...
        		<tr>
        			<td align="left" class="textbody">&nbsp;</td>
        			<td align="left" class="textbody"><input type="radio" name="searchby" value="email"<?php if (($_POST['searchby'] !== 'firstname') || ($_POST['searchby'] !== 'lastname')) print " checked"; ?>> E-mail Address</td>
        		</tr>
        		<tr>
      ...
      <tr valign="middle">
        <td colspan="2" valign="middle" align="center" bgcolor="#FFFFFF" class="textbody">
        	...
        	<a href="javascript:getLastName('Z');">Z</a></td>
      </tr>
      <tr valign="middle"><form name="regstat" id="regstat" method="POST" action="user_summary.php">
        <td colspan="2" valign="middle" align="center" bgcolor="#FFFFFF" class="textbody">Registration Status:
              ...
              <input type="hidden" name="searchby" value="registration_status"></td></form>
      </tr>
    </table>
    ...
    <table width="100%"  border="0" align="center" cellpadding="5" cellspacing="1" id="results">
        ...
        <tr bgcolor="#EDEDED" class="text1">
          ...
          <td class="text1"><?php print $row['email']; ?></td>
          <td class="text1"><?php print $row['password']; ?></td>
        ...
        ?>
        	<tr bgcolor="#EDEDED" class="text1"><td colspan="6" class="text1">There were no records that matched your query.</td></tr>
        <?php
        	}
        ?>
    </table>
