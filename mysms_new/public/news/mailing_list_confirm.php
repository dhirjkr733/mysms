...
// Form validation starts here ---------------------------
	...
	if ($error_msg !== "") {
		...
		if (!$result) {
			include_once($_SERVER['DOCUMENT_ROOT'].'/public/register/mailing_list_error.php');
		} else {
			...
			mail(MAILING_LIST_EMAIL.$emails_result,"MySMS Request to Join Mailing List",$mailmsg,"From: ".ADMINISTRATION_EMAIL."\r\n");
			$confirm = true;
		}
	}
...
$edit_ary = array (
	"chunk1" => array (
		...
		"blanks"=>"1",		
		"table_name"=>"public_mail_confirm",
