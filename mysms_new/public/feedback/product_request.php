...
$edit_ary = array (
	"chunk1" => array (
		...
		"blanks"=>"1",		
		"table_name"=>"public_request_product",
...
<table width="755" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr valign="top" bgcolor="#FFFFFF">
    ...
    <td colspan="5" valign="top" bgcolor="#FFFFFF"><table width="525"  border="0" align="center" cellpadding="5" cellspacing="0" id="desc">
      ...
      <tr bgcolor="#FFFFFF">
        <td valign="top" bgcolor="#FFFFFF" class="text1"><?php content_display("chunk1","<p>","</p>"); ?><font color="#CC0000"> <strong><b><br>
* </b></strong><b>Required Fields </b></font></p>
        ...
        <tr bgcolor="#FFFFFF">
          ...
          <?php
          	if((isset($return_form))) {
          		form_productrequest("",$return_form);
          	} else {
          		form_productrequest();
          	} 
          ?></td>
